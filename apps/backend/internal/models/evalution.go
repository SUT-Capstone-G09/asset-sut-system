...
type EvaluationsDetail struct {
	...
	Score                *int   `gorm:"default:null" json:"score"`      // null = N/A
	Status               string `gorm:"type:varchar(50)" json:"status"` // "Pass", "Improvement", "Fail"
...
type EvaluationCriteria struct {
	...
	Category      string          `gorm:"type:varchar(100);not null;index" json:"category"` // หมวดหมู่ของเกณฑ์
	BusinessTypes []BusinessTypes `gorm:"many2many:evaluation_criteria_business_types;" json:"business_types,omitempty"`
}
