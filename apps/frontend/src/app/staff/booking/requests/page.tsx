...
function StaffBookingPageContent() {
  ...
  // Get filter actions for active type, filtered by staff user ID
  const {
    bookings,
    searchQuery,
    setSearchQuery,
    ...
    return (
      <div className="p-8 space-y-8 animate-in fade-in duration-300">
        ...
        <div className="space-y-4">
          ...
          />
          <h1 className="text-3xl font-black text-slate-800 tracking-tight">คำขอจองพื้นที่</h1>
        </div>
  ...
  return (
    <div className="p-8 space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <BookingHeader
        ...
        breadcrumbs={[
          { label: "Staff Portal", href: "/staff/dashboard" },
          { label: "คำขอจองพื้นที่", href: "/staff/booking/requests" }, // Clicking this clears type query and returns to cards
          { label: typeLabel },
        ]}
