...
export default function RoomCard({ room }: RoomCardProps) {
  ...
  return (
    <Link
      ...
      className="block bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden group hover:-translate-y-1 hover:shadow-md transition-all duration-300"
    >
      {/* Image */}
