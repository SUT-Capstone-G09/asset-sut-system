...
interface Props {
  open: boolean;
  onClose: () => void;
  onSave: (newHall: Hall) => void | Promise<void>;
}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
                    กรอกข้อมูลเพื่อบันทึกเข้าสู่ระบบ
                  </p>
                </div>
                <SheetDescription className="sr-only">
                  กรอกข้อมูลโถงพื้นที่ที่ฟอร์มด้านล่างเพื่อสร้างใหม่
                </SheetDescription>
              </div>
              <button
                type="button"
            ...
            <div className="px-6 py-5 border-t border-slate-100 flex flex-col gap-3 bg-white/90 backdrop-blur-md shrink-0">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  ...
                  {isSubmitting ? "กำลังบันทึก..." : "บันทึกโถงพื้นที่"}
                </Button>
              </div>
            </div>
          </form>
