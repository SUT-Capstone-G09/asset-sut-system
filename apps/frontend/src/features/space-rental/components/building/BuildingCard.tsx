...
import { calculateBuildingStats } from "@/features/space-rental/utils/calculate-building-stats";
  ...
  if (viewMode === "list") {
    return (
      <button
        ...
        onClick={onSelect}
        className={cn(
          "group w-full flex items-center gap-4 px-5 py-3.5 rounded-md border text-left transition-all duration-200",
          isSelected
      ...
      >
        ...
        <div className="flex flex-1 flex-col justify-between p-6 w-full pl-7">
          <div className="flex w-full items-start justify-between">
            <div
              className={cn(
                "flex h-12 w-12 items-center justify-center rounded-md transition-all duration-300",
                isSelected
